        ...
        <Waypoints target={"tocontact"}>
          <section id="contact" className="pt-28">
            ...
            <div className="flex justify-center">
              <div
                className="bg-[#6C63FF] w-[180px] rounded-lg h-[5px] mt-3"
                data-aos="fade-up"
                data-aos-delay="400"
              ></div>
            </div>
              ...
              <div className="flex flex-col justify-between">
                <div>
                  <div>
                    ...
                    <div
                      className="bg-[#6C63FF] w-[130px] rounded-lg h-[5px] my-3"
                      data-aos="fade-right"
                      data-aos-duration="1000"
                    ></div>

                    <ul className="list-disc ml-5 mt-1">
                      <li>{`elapsedUser#3765`}</li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="list-disc ml-5 mt-1">
                      <li>
                        <a
                          href="mailto:mamidisettisanthosh2004@gmail.com"
                          className="hover:text-indigo-500"
                        >
                          mamidisettisanthosh2004@gmail.com
                        </a>{" "}
                        (main)
                      </li>
                    </ul>
