...
module.exports = {
  siteMetadata: {
    ...
    description:
      'Santhosh Mamidisetti is a Robotics Software Engineer with expertise in Computer Vision, Perception and AI. Specializing in autonomous systems, robotics software development, and advanced perception algorithms.',
    siteUrl: 'https://santhosh-mamidisetti.github.io', // No trailing slash allowed!
    image: '/og.png', // Path to your image you placed in the 'static' folder
    twitterUsername: '@_m_santhosh_',
    keywords: 'Santhosh Mamidisetti, robotics, software engineer, computer vision, perception, AI, autonomous systems, robotics software developer, machine learning engineer, portfolio',
    author: 'Santhosh Mamidisetti',
    lang: 'en',
    headline: 'Robotics Software Engineer specializing in Computer Vision and AI',
    github: 'https://github.com/santhosh-mamidisetti',
    linkedin: 'https://www.linkedin.com/in/santhosh-mamidisetti',
  },
  plugins: [
    ...
    },
    {
      ...
      options: {
        ...
        description: 'Santhosh Mamidisetti is a Robotics Software Engineer with expertise in Computer Vision, Perception and AI.',
        lang: 'en',
        ...
        shortcuts: [
          {
            name: 'About',
            url: '/#about',
            description: 'Learn more about Santhosh Mamidisetti'
          },
          {
            name: 'Projects',
            url: '/#projects',
